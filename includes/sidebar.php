<div class="row">
	<div class="box box-solid">
	  	<div class="box-header with-border">
	    	<h3 class="box-title"><b>Les plus regarder aujourd hui</b></h3>
	  	</div>
	  	<div class="box-body">
	  		<ul id="trending">
	  		<?php
	  			$now = date('Y-m-d');
                $res=executeRequete("SELECT * FROM produits WHERE dernierreObservation='$now' ORDER BY id DESC LIMIT 10");
	  			while($valeur=$res->fetch_assoc()){
	  				echo "<li><a href='produit.php?produit=".$valeur['id']."'>".$valeur['nom']."</a></li>";
	  			}
	  		?>
	    	<ul>
	  	</div>
